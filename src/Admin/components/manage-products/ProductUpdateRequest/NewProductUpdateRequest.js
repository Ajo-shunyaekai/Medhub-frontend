...
import '../../../assest/style/dashboardorders.css';
...
const NewProductUpdateRequest = ({productList, totalProducts, currentPage, listPerPage, handlePageChange, activeLink}) => {
...
export default NewProductUpdateRequest;