        ...
        <div className='active-order-details-container'>
            <div className='active-order-main-section-container'>
                <div className='active-order-details-conatiner-heading'>
                    ...
                    <Link className='active-order-details-link-tag' to={`/admin/buyer-details/${orderDetails?.buyer_id}`}>
                        <span className='active-details-purchsed-by'>Purchased By: </span><span className='active-details-Buyer-name'>{orderDetails?.supplier?.supplier_name ||
