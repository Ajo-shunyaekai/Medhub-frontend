...
const ActiveSellerOrder = ({orderList, totalOrders, currentPage, ordersPerPage, handlePageChange}) => {
    const actives = [
        {
           id: "125252",
            date: "12/10/2024",
                        ...
                        <Table responsive="xxl" className={styles['actives-table-responsive']}>
                            ...
                            {orderList?.map((order, index) => {
                                    ...
                                    <div className={styles['actives-table-row-container']} key={index}>
                                        ...
                                        <div className={`${styles['actives-table-row-item']} ${styles['actives-table-order-1']}`}>
                                            <div className={styles['actives-table-text-color']}>{order.order_status ? 'Order Placed' : ''}</div>
                                        </div>
...
export default ActiveSellerOrder;
