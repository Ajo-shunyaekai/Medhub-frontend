...
import logo from "../../assets/svgs/navibluelogo.svg";
      ...
      try {
        ...
        setTimeout(() => {
          window.location.pathname == "/buyer/login"
            ...
            : window.location.pathname == "/supplier/login"
            ? navigate("/supplier")
            : window.location.pathname == "/admin/login" && navigate("/admin");
          setLoading(true);
        }, 500);
        ...
        if ("Notification" in window) {
          if (Notification.permission === "granted") {
            ...
            const userId = data?.buyer_id || data.supplier_id || data?.admin_id;
            socket.emit(
              window.location.pathname == "/buyer/login"
                ? "registerBuyer"
                : window.location.pathname == "/supplier/login"
            ...
            if (permission === "granted") {
              const userId =
                data?.buyer_id || data.supplier_id || data?.admin_id;
              socket.emit(
                window.location.pathname == "/buyer/login"
                  ? "registerBuyer"
                  : window.location.pathname == "/supplier/login"
          ...
          <>
            ...
            <div className={styles.loginFormMainSignup}>
              ...
              <Link to="/buyer/sign-up">
                <span className={styles.loginSignupHere}>
                  &nbsp;Sign up here
                </span>
              </Link>
            </div>
