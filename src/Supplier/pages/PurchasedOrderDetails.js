                    ...
                    <table style={{ fontSize: '12px' }}>
                        <thead>
                            <div className={styles['purchased-order-container']}>
                                <tr>
                                    <td>
                                        <img src={CompanyLogo} alt="companylogo" className={styles['purchange-logo']} />
                                    </td>
                                </tr>
                                            ...
                                            <tr style={{ borderBottom: '1px dotted #99a0ac' }}>
                                                <td style={{ verticalAlign: 'top', width: '60%', paddingRight: '20px', paddingBottom: '20px' }}>
                                                    ...
                                                    <td style={{ display: 'flex', justifyContent: 'start' }}>
                                                        ...
                                                        <p style={{ fontSize: '13px', lineHeight: '16px', color: '#99a0ac', paddingTop: '6px' }}>&nbsp;+971 123456654</p>
                                                    </td>
                                                    <td style={{ display: 'flex', justifyContent: 'start' }}>
                                                        <p style={{ fontSize: '13px', lineHeight: '16px', color: '#99a0ac', paddingTop: '6px' }}>Email ID :</p>
                                                        <p style={{ fontSize: '13px', lineHeight: '16px', color: '#99a0ac', paddingTop: '6px' }}>&nbsp;asif.mohd@gmail.com</p>
                                                    </td>
                                                    <td style={{ display: 'flex', justifyContent: 'start' }}>
