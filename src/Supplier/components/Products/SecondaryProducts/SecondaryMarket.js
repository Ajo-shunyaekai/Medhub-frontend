        ...
        <div className={styles["support-container"]}>
          ...
          {productList && productList.length > 0 ? (
            productList?.map((product, i) => {
              const firstImage = Array.isArray(product?.medicine_image)
                ...
                <div className="buy-product-card-section" key={i}>
                  ...
                  <div className="buy-product-card-first-section">
                    <div className="buy-product-card-first-left">
                      <div className="buy-product-card-first-copmany-name">
                        {product.medicine_name}
                      </div>
                      <div className="buy-product-card-first-copmany-description">
                    ...
                    <div className="buy-product-card-second-section">
                      <div className="buy-product-card-second-head">
                        Country of Origin
                      </div>
                      <div className="buy-product-card-second-text">
            ...
            <>
              <div className={styles["support-add-card"]}>
                <span className={styles["support-span"]}>
