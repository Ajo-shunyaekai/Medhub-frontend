...
//   console.log("selectedFile", fileIndex, selectedFile);

//   const onDrop = useCallback(
//     (acceptedFiles) => {
//       setFieldValue(fieldInputName, acceptedFiles);
//       setFilesMerged([...acceptedFiles]); // Set the existing files
//     },
...
//     setFieldValue(fieldInputName, {});
//     setFilesMerged([]); // Set the existing files
//   };
