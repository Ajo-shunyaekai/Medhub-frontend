  ...
  const EditAddProduct = ({ placeholder }) => {
    ...
    useEffect(() => {
      formik &&
        formik.setValues({
          name: productDetail?.general?.name || "",
          description: productDetail?.general?.description || "",
          manufacturer: productDetail?.general?.manufacturer || "",
          aboutManufacturer: productDetail?.general?.aboutManufacturer || "",
          countryOfOrigin: productDetail?.general?.countryOfOrigin || "",
          upc: productDetail?.upc || "",
          model: productDetail?.model || "",
          image: productDetail?.image || [],
          imageNew: productDetail?.imageNew || [],
