...
const EditProduct = ({ placeholder }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      healthHazardRating: productDetail?.healthHazardRating || [],
      ...
      controlledSubstance: productDetail?.[productDetail?.category]?.controlledSubstance || false,
      otcClassification: productDetail?.[productDetail?.category]?.otcClassification || "",
      ...
      drugAdministrationRoute: productDetail?.[productDetail?.category]?.drugAdministrationRoute || "",
      ...
      crueltyFree: productDetail?.[productDetail?.category]?.crueltyFree || false,
      sideEffectsAndWarnings: productDetail?.[productDetail?.category]?.sideEffectsAndWarnings || "",
      thickness: productDetail?.[productDetail?.category]?.thickness || "",
      interoperability: productDetail?.[productDetail?.category]?.interoperability || "",
      interoperabilityFile: productDetail?.[productDetail?.category]?.interoperabilityFile || [],
      interoperabilityFileNew: productDetail?.[productDetail?.category]?.interoperabilityFileNew || [],
      specification: productDetail?.[productDetail?.category]?.specification || "",
      specificationFile: productDetail?.[productDetail?.category]?.specificationFile || [],
      specificationFileNew: productDetail?.[productDetail?.category]?.specificationFileNew || [],
      diagnosticFunctions: productDetail?.[productDetail?.category]?.diagnosticFunctions || "",
      performanceTestingReport: productDetail?.[productDetail?.category]?.performanceTestingReport || "",
      performanceTestingReportFile: productDetail?.[productDetail?.category]?.performanceTestingReportFile || [],
      performanceTestingReportFileNew: productDetail?.[productDetail?.category]?.performanceTestingReportFileNew || [],
      additivesNSweeteners: productDetail?.[productDetail?.category]?.additivesNSweeteners || "",
      powdered: productDetail?.[productDetail?.category]?.powdered || false,
      productMaterial: productDetail?.[productDetail?.category]?.productMaterial || "",
      productMaterialIfOther: productDetail?.[productDetail?.category]?.productMaterialIfOther || "",
      ...
      chemicalResistance: productDetail?.[productDetail?.category]?.chemicalResistance || false,
      fluidResistance: productDetail?.[productDetail?.category]?.fluidResistance || false,
      shape: productDetail?.[productDetail?.category]?.shape || "",
      coating: productDetail?.[productDetail?.category]?.coating || "",
      concentration: productDetail?.[productDetail?.category]?.concentration || "",
      measurementRange: productDetail?.[productDetail?.category]?.measurementRange || "",
      maintenanceNotes: productDetail?.[productDetail?.category]?.maintenanceNotes || "",
      compatibleEquipment: productDetail?.[productDetail?.category]?.compatibleEquipment || "",
      usageRate: productDetail?.[productDetail?.category]?.usageRate || "",
      adhesiveness: productDetail?.[productDetail?.category]?.adhesiveness || "",
      absorbency: productDetail?.[productDetail?.category]?.absorbency || "",
      targetCondition: productDetail?.[productDetail?.category]?.targetCondition || "",
      elasticity: productDetail?.[productDetail?.category]?.elasticity || "",
      breathability: productDetail?.[productDetail?.category]?.breathability || "",
      foldability: productDetail?.[productDetail?.category]?.foldability || "",
      fragrance: productDetail?.[productDetail?.category]?.fragrance || "",
      healthBenefit: productDetail?.[productDetail?.category]?.healthBenefit || "",
      ...
      coolingSystem: productDetail?.[productDetail?.category]?.coolingSystem || "",
      ...
      dermatologistTested: productDetail?.[productDetail?.category]?.dermatologistTested || "",
      dermatologistTestedFile: productDetail?.[productDetail?.category]?.dermatologistTestedFile || [],
      dermatologistTestedFileNew: productDetail?.[productDetail?.category]?.dermatologistTestedFileNew || [],
      pediatricianRecommended: productDetail?.[productDetail?.category]?.pediatricianRecommended || "",
      pediatricianRecommendedFile: productDetail?.[productDetail?.category]?.pediatricianRecommendedFile || [],
      pediatricianRecommendedFileNew: productDetail?.[productDetail?.category]?.pediatricianRecommendedFileNew || [],
      moisturizers: productDetail?.[productDetail?.category]?.moisturizers || "",
      ...
      filtrationEfficiency: productDetail?.[productDetail?.category]?.filtrationEfficiency || "",
      layerCount: productDetail?.[productDetail?.category]?.layerCount || "",
      filtrationType: productDetail?.[productDetail?.category]?.filtrationType || [],
      // Add the other fields under LaboratorySupplies || Add the other fields under LaboratorySupplies
      magnificationRange: productDetail?.[productDetail?.category]?.magnificationRange || "",
      objectiveLenses: productDetail?.[productDetail?.category]?.objectiveLenses || "",
      powerSource: productDetail?.[productDetail?.category]?.powerSource || "",
      resolution: productDetail?.[productDetail?.category]?.resolution || "",
      connectivity: productDetail?.[productDetail?.category]?.connectivity || "",
      casNumber: productDetail?.[productDetail?.category]?.casNumber || "",
      grade: productDetail?.[productDetail?.category]?.grade || "",
      physicalState: productDetail?.[productDetail?.category]?.physicalState || [],
      hazardClassification: productDetail?.[productDetail?.category]?.hazardClassification || [],
      ...
      moistureResistance: productDetail?.[productDetail?.category]?.moistureResistance || "",
      ...
      lensMaterial: productDetail?.[productDetail?.category]?.lensMaterial || "",
      // Add the other fields under HomeHealthcareProducts || Add the other fields under HomeHealthcareProducts
      maxWeightCapacity: productDetail?.[productDetail?.category]?.maxWeightCapacity || "",
      gripType: productDetail?.[productDetail?.category]?.gripType || "",
      lockingMechanism: productDetail?.[productDetail?.category]?.lockingMechanism || "",
      typeOfSupport: productDetail?.[productDetail?.category]?.typeOfSupport || "",
      ...
      healthClaims: productDetail?.[productDetail?.category]?.healthClaims || "",
      healthClaimsFile: productDetail?.[productDetail?.category]?.healthClaimsFile || [],
      healthClaimsFileNew: productDetail?.[productDetail?.category]?.healthClaimsFileNew || [],
      // Add the other fields under EmergencyAndFirstAidSupplies || Add the other fields under EmergencyAndFirstAidSupplies
      productLongevity: productDetail?.[productDetail?.category]?.productLongevity || "",
      flavorOptions: productDetail?.[productDetail?.category]?.flavorOptions || "",
      aminoAcidProfile: productDetail?.[productDetail?.category]?.aminoAcidProfile || "",
      ...
      scalabilityInfo: productDetail?.[productDetail?.category]?.scalabilityInfo || "",
      ...
      coreFunctionalities: productDetail?.[productDetail?.category]?.coreFunctionalities || "",
    },
          ...
          <form className={styles.form} onSubmit={e=>{
              ...
              <div className={styles.formSection}>
                ...
                <div className={styles.productContainer}>
                  ...
                  {formik.touched.subCategory && formik.errors.subCategory && (
                    <span className={styles.error}>{formik.errors.subCategory}</span>
                  )}
                </div>
                ...
                {productType === "secondary product" && (
                  <>
                    <div className={styles.productContainer}>
                      ...
                      />
                      {formik.touched.purchasedOn && formik.errors.purchasedOn && (
                    ...
                    <div className={styles.productContainer}>
                      ...
                      <Select
                        ...
                        onBlur={formik?.handleBlur}
                        onChange={(selectedOption) => {
                          formik.setFieldValue("condition", selectedOption?.value);
                        }}
                      />
                      {formik.touched.condition && formik.errors.condition && (
                        <span className={styles.error}>{formik.errors.condition}</span>
                      )}
                    </div>
                      ...
                      <MultiSelectDropdown
                        ...
                        onChange={(selectedOptions) => {
                          ...
                          const selectedValues = selectedOptions
                            ...
                            : [];
                          formik.setFieldValue("countryAvailable", selectedValues); // Update Formik value with the selected country values
                        }}
                        onBlur={formik?.handleBlur} // Optional: add this if the component has a blur event
                      />

                      {formik.touched.countryAvailable && formik.errors.countryAvailable && (
                        <span className={styles.error}>
                ...
                <div className={styles.productContainer}>
                  ...
                  <div className={styles.tooltipContainer}>
                    <Select
                      ...
                      onBlur={formik?.handleBlur}
                      onChange={(selectedOption) => {
                        formik.setFieldValue("packageType", selectedOption?.value);
                      }}
                  ...
                  {formik.touched.packageType && formik.errors.packageType && (
                    <span className={styles.error}>{formik.errors.packageType}</span>
                  )}
                </div>
                <div className={styles.productContainer}>
                  <label className={styles.formLabel}>
                    ...
                    <Select
                      ...
                      value={
                        materialOptions.find(
                          (option) => option.value === formik?.values?.packageMaterial
                        ) || null
                  ...
                  {selectedOption?.value === "Other" && (
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        formik.setFieldValue("packageMaterialIfOther", e.target.value);
                      }}
                    />
                  )}

                  {/* Display error message if any */}
                  {formik.touched.packageMaterial && formik.errors.packageMaterial && (
                    <span className={styles.error}>
                ...
                <div className={styles.productContainer}>
                  ...
                  {formik.touched.manufacturer && formik.errors.manufacturer && (
                    <span className={styles.error}>{formik.errors.manufacturer}</span>
                  )}
                </div>
                ...
                <div className={styles.productContainer}>
                  ...
                  />
                  {formik.touched.aboutManufacturer && formik.errors.aboutManufacturer && (
                    <span className={styles.error}>
              ...
              <div className={styles.formSection}>
                ...
                <div className={styles.productContainer}>
                  ...
                  {formik.touched.countries && formik.errors.countries && (
                    <span className={styles.error}>{formik.errors.countries}</span>
                  )}
                </div>
              </div>
                  ...
                  {formik?.values?.productPricingDetails?.length > 1 && (
                    <div
                      ...
                      onClick={() => {
                        ...
                        const updatedList = formik?.values?.productPricingDetails.filter(
                          (_, elindex) => elindex !== index
                        );
                        formik.setFieldValue("productPricingDetails", updatedList);
                      }}
                    >
                      <span className={styles.formclose}>
                        <CloseIcon className={styles.icon} />
            ...
            <div className={styles.documentContainer}>
              ...
              <div className={styles.sectionCompliances}>
                ...
                />
                {formik.touched.complianceFile && formik.errors.complianceFile && (
                  <span className={styles.error}>{formik.errors.complianceFile}</span>
                )}
              </div>
            </div>
              ...
              <div className={styles.section}>
                ...
                <div className={styles.formSection}>
                  ...
                  <div className={styles.productContainer}>
                    ...
                    <AddProductFileUpload
                      maxfileCount={
                        4 - (formik?.values?.performanceTestingReportFile?.length || 0)
                      }
                  ...
                  <div className={styles.productContainer}>
                    ...
                    <AddProductFileUpload
                      ...
                      showLabel={false}
                    />
                    {formik.touched.specificationFile && formik.errors.specificationFile && (
                      <span className={styles.error}>
                  ...
                  <div className={styles.formSection}>
                    ...
                    <div className={styles.productContainer}>
                      ...
                      {formik.touched.drugClass && formik.errors.drugClass && (
                        <span className={styles.error}>{formik.errors.drugClass}</span>
                      )}
                    </div>
                    <div className={styles.productContainer}>
                      <label className={styles.formLabel}>
                      ...
                      {formik.touched.strength && formik.errors.strength && (
                        <span className={styles.error}>{formik.errors.strength}</span>
                      )}
                    </div>
                    <div className={styles.productContainer}>
                      <label className={styles.formLabel}>
                ...
                <div className={styles.section}>
                  ...
                  <div className={styles.formSection}>
                    ...
                    <div className={styles.productContainer}>
                      ...
                      {formik.touched.targetCondition && formik.errors.targetCondition && (
                        <span className={styles.error}>
                      ...
                      <div className={styles.tooltipContainer}>
                        <span className={styles.formCheckboxSection}>
                          <input
                            ...
                            name="vegan"
                            onBlur={formik?.handleBlur}
                            checked={formik?.values?.vegan || checked["vegan"] || false}
                            onChange={(e) => {
                        ...
                        <span className={styles.formCheckboxSection}>
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              formik.setFieldValue("crueltyFree", e?.target?.checked);
                            }}
                          />
                          ...
                          {dermatologistTested === "Yes" && (
                            <>
                              <AddProductFileUpload
                                maxfileCount={
                                  4 -
                                  (formik?.values?.dermatologistTestedFile?.length || 0)
                                }
                ...
                <div className={styles.section}>
                  ...
                  <div className={styles.formSection}>
                    ...
                    <div className={styles.productContainer}>
                      ...
                      {formik.touched.healthBenefit && formik.errors.healthBenefit && (
                        <span className={styles.error}>
                      ...
                      <div className={styles.tooltipContainer}>
                        <span className={styles.formCheckboxSection}>
                          <input
                            ...
                            id="powdered"
                            checked={
                              formik?.values?.powdered || checked["powdered"] || false
                            }
                            onChange={(e) => {
                              handleCheckboxChange(
                                "powdered",
                              ...
                              formik.setFieldValue("powdered", e?.target?.checked);
                            }}
                          />
                      ...
                      <div className={styles.tooltipContainer}>
                        <span className={styles.formCheckboxSection}>
                          <input
                            ...
                            id="texture"
                            checked={
                              formik?.values?.texture || checked["texture"] || false
                            }
                            onChange={(e) => {
                              handleCheckboxChange(
                                "texture",
                  ...
                  <div className={styles.formSection}>
                    ...
                    <div className={styles.productContainer}>
                      ...
                      <AddProductFileUpload
                        maxfileCount={
                          4 -
                          (formik?.values?.performanceTestingReportFile?.length || 0)
                        }
                        fieldInputName={"performanceTestingReportFileNew"}
                        setFieldValue={formik.setFieldValue}
                        initialValues={formik?.values}
                  ...
                  <div className={styles.formSection}>
                    ...
                    <div className={styles.productContainer}>
                      ...
                      <Select
                        ...
                        name="lensMaterial"
                        onChange={(selectedOption) =>
                          formik.setFieldValue("lensMaterial", selectedOption?.value)
                        }
                        onBlur={formik?.handleBlur}
                      />
                        ...
                        <div className={styles.productInnerContainer}>
                          ...
                          <div className={styles.tooltipContainer}>
                            <input
                              ...
                              // onChange={formik?.handleChange}
                              onChange={(e) =>
                                handleInputChange(e, formik.setFieldValue, 20, "text")
                              }
                              onBlur={formik?.handleBlur}
                            />
                            <span
                  ...
                  <div className={styles.formSection}>
                    ...
                    <div className={styles.productContainer}>
                      ...
                      <AddProductFileUpload
                        ...
                        showLabel={false}
                      />
                      {formik.touched.healthClaimsFile && formik.errors.healthClaimsFile && (
                        <span className={styles.error}>
                ...
                <div className={styles.section}>
                  ...
                  <div className={styles.formSection}>
                    ...
                    <div className={styles.productContainer}>
                      ...
                      {formik.touched.productLongevity && formik.errors.productLongevity && (
                        <span className={styles.error}>
                    ...
                    <div className={styles.productContainer}>
                      ...
                      {formik.touched.foldability && formik.errors.foldability && (
                        <span className={styles.error}>
                ...
                <div className={styles.section}>
                  ...
                  <div className={styles.formSection}>
                    <div className={styles.productContainer}>
                      ...
                      <div className={styles.tooltipContainer}>
                        <Select
                          ...
                          name="dairyFree"
                          onChange={(selectedOption) =>
                            formik.setFieldValue("dairyFree", selectedOption?.value)
                          }
                          onBlur={formik?.handleBlur}
                        />
                        <span
                      ...
                      {formik.touched.dairyFree && formik.errors.dairyFree && (
                        <span className={styles.error}>{formik.errors.dairyFree}</span>
                      )}
                    </div>
                    <div className={styles.productContainer}>
                      <label className={styles.formLabel}>
                      ...
                      {formik.touched.flavorOptions && formik.errors.flavorOptions && (
                        <span className={styles.error}>
                    ...
                    <div className={styles.productContainer}>
                      ...
                      {formik.touched.aminoAcidProfile && formik.errors.aminoAcidProfile && (
                        <span className={styles.error}>
                ...
                <div className={styles.section}>
                  ...
                  <div className={styles.formSection}>
                    <div className={styles.productContainer}>
                      ...
                      {formik.touched.scalabilityInfo && formik.errors.scalabilityInfo && (
                        <span className={styles.error}>
                    ...
                    <div className={styles.innerSection}>
                      ...
                      <div className={styles.formInnerSection}>
                        ...
                        <div className={styles.productInnerContainer}>
                          ...
                          {formik.touched.userAccess && formik.errors.userAccess && (
                            <span className={styles.error}>
                    ...
                    <div className={styles.innerMonitorSection}>
                      ...
                      <div className={styles.formInnerSection}>
                        ...
                        <div className={styles.productInnerContainer}>
                          ...
                          <AddProductFileUpload
                            maxfileCount={
                              4 - (formik?.values?.interoperabilityFile?.length || 0)
                            }
            ...
            <div className={styles.section}>
              ...
              <div className={styles.formSection}>
                <AddProductFileUpload
                  maxfileCount={4 - (formik?.values?.safetyDatasheet?.length || 0)}
                ...
                <AddProductFileUpload
                  maxfileCount={4 - (formik?.values?.healthHazardRating?.length || 0)}
                ...
                <AddProductFileUpload
                  maxfileCount={4 - (formik?.values?.environmentalImpact?.length || 0)}
              ...
              <div className={styles.formSection}>
                {formik.touched.safetyDatasheet && formik.errors.safetyDatasheet && (
                  <span className={styles.error}>{formik.errors.safetyDatasheet}</span>
                )}

                {formik.touched.healthHazardRating && formik.errors.healthHazardRating && (
                  <span className={styles.error}>
                    {formik.errors.healthHazardRating}
                  </span>
                )}

                {formik.touched.environmentalImpact && formik.errors.environmentalImpact && (
                  <span className={styles.error}>
            ...
            <div className={styles.additionalSection}>
              ...
              <div className={styles.formSection}>
                ...
                />
                {formik.touched.guidelinesFile && formik.errors.guidelinesFile && (
                  <span className={styles.error}>{formik.errors.guidelinesFile}</span>
                )}
                <div className={styles.productContainer}>
