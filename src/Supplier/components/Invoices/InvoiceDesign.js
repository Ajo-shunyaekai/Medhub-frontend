...
function InvoiceDesign() {
  ...
  const formatAddress = (addressDetails, primaryAddress) => {
    ...
    const address1 =
      [primaryAddress || company_reg_address, locality]
        .filter(Boolean)
        .join(", ") || "Address 1";
    const address2 =
      [land_mark, country, city, state, pincode].filter(Boolean).join(", ") ||
      "Address 2";
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const response = await apiRequests.getRequest(
        `invoice/get-specific-invoice-details/${invoiceId}`,
        obj
      );
        ...
        <div id="invoice-content">
          ...
          >
            ...
            <table style={{ fontSize: "12px" }}>
                      ...
                      <tbody>
                        <tr style={{ borderBottom: "1px solid #99a0ac" }}>
                          ...
                          >
                            ...
                            <p
                              style={{ fontSize: "0.825rem", color: "#99A0AC" }}
                            >
                              {supplierAddressLines[0]}
                            </p>
                            <p
                              style={{ fontSize: "0.825rem", color: "#99A0AC" }}
                            >
                              {supplierAddressLines[1]}
                            </p>
                            <td
                              style={{
                                display: "flex",
                            ...
                            >
                              ...
                              >
                                &nbsp;{invoiceDetails?.supplier_vat_reg_no}
                              </p>
                            </td>
                          </td>
                          <td
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                &nbsp;{invoiceDetails?.buyer_vat_reg_no}
                              </p>
                            </td>
                          </td>
                        </tr>
              ...
              <tfoot>
                <tbody
                  style={{ width: "100vw", Fournier: "1px solid #99a0ac" }}
                >
                  <tr>
                    <td
                      style={{
