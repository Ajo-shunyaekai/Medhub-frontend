                ...
                <div id='invoice-content'>
                    <div style={{
                        ...
                        <table style={{ fontSize: '12px' }}>
                                            ...
                                            <tbody>
                                                <tr style={{ borderBottom: '1px solid #616161' }}>
                                                    <td style={{ verticalAlign: 'top', width: '60%', paddingRight: '20px', paddingBottom: '20px' }}>
                                                        ...
                                                        <p style={{ fontSize: '13px', color: "#616161", fontWeight: '500' }}>{supplierAddressLines[0]}</p>
                                                        <p style={{ fontSize: '13px', color: "#616161", fontWeight: '500' }}>{supplierAddressLines[1]}</p>
                                                    ...
                                                    <td style={{ verticalAlign: 'top', width: '40%', paddingBottom: '20px' }}>
                                                        ...
                                                        <p style={{ fontSize: '13px', color: "#616161", fontWeight: '500', textAlign: 'end' }}>{buyerAddressLines[0]}</p>
                                                        <p style={{ fontSize: '13px', color: "#616161", fontWeight: '500', textAlign: 'end' }}>{buyerAddressLines[1]}</p>
                                                        <td style={{ display: 'flex', justifyContent: 'end' }}>
                            ...
                            <tfoot>
                                <tbody style={{ width: '100vw', Fournier: '1px solid #616161' }}>
                                    <tr>
