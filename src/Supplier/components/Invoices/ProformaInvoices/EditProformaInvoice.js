...
const EditProformaInvoice = () => {
    ...
    postRequestWithToken(
      ...
      async (response) => {
        if (response.code === 200) {
          ...
          setValue(
            "supplierName",
            response?.result?.supplier_details[0]?.supplier_name
          );
          setValue(
            "supplierAddress",
            response?.result?.supplier_details[0]?.supplier_address
          );
          setValue(
            "supplierEmail",
          ...
          setValue(
            "buyerAddress",
            response?.result?.buyer_details[0]?.buyer_address
          );
          setValue(
            "buyerEmail",
  ...
  const formatPhoneNumber = (phoneNumber, countryCode) => {
    ...
    if (cleanedNumber.length <= 10) {
      ...
      // Longer numbers
      return `+${countryCode}-${cleanedNumber.slice(
        0,
        6
  ...
  return (
    <div className={styles["create-invoice-container"]}>
      ...
      <form
        className={styles["craete-invoice-form"]}
      ...
      >
          ...
          <div className={styles["create-invoice-inner-form-container"]}>
            <div className={styles["create-invoice-div-container"]}>
              ...
              <input
                ...
                {...register("supplierName", {
                  validate: (value) =>
                    value?.trim() !== "" || "Supplier name is required",
                })}
              />
            </div>
            ...
            <div className={styles["create-invoice-div-container"]}>
              ...
              {errors.depositRequested && (
                <p>{errors.depositRequested.message}</p>
              )}
            </div>
            <div className={styles["create-invoice-div-container"]}>
              <label className={styles["create-invoice-div-label"]}>
              ...
              <input
                ...
                {...register("depositDue", {
                  validate: (value) =>
                    value?.trim() !== "" || "Deposit due is required",
                })}
                onInput={handleNumberInput}
              />
            ...
            <div className={styles["create-invoice-div-container"]}>
              ...
              <input
                ...
                {...register("supplierEmail", {
                  validate: (value) =>
                    value?.trim() !== "" || "Supplier email is required",
                })}
              />
            ...
            <div className={styles["create-invoice-div-container"]}>
              ...
              <input
                ...
                {...register("supplierAddress", {
                  validate: (value) =>
                    value?.trim() !== "" || "Supplier address is required",
                })}
              />
          ...
          <div className={styles["create-invoice-inner-form-container"]}>
            <div className={styles["create-invoice-div-container"]}>
              ...
              <input
                ...
                {...register("buyerName", {
                  validate: (value) =>
                    value?.trim() !== "" || "Buyer name is required",
                })}
              />
            ...
            <div className={styles["create-invoice-div-container"]}>
              ...
              <input
                ...
                {...register("buyerEmail", {
                  validate: (value) =>
                    value?.trim() !== "" || "Buyer email is required",
                })}
              />
            ...
            <div className={styles["create-invoice-div-container"]}>
              ...
              <input
                ...
                {...register("buyerAddress", {
                  validate: (value) =>
                    value?.trim() !== "" || "Buyer address is required",
                })}
              />
        ...
        <div className={styles["craete-invoices-button"]}>
          <button type="submit" className={styles["create-invoices-submit"]}>
            Save
          </button>
