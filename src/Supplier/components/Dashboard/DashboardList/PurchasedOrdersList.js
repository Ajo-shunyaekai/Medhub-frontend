                  ...
                  poList.map((order, i) => {
                    ...
                    return (
                      <div className="completed-table-row-container">
                        ...
                        <div className="completed-table-row-item completed-table-order-1">
                          <div className="completed-table-text-color">
                            {order?.po_status?.charAt(0).toUpperCase() +
                              order?.po_status?.slice(1)}
                          </div>
                        </div>
                        <div className="completed-table-row-item  completed-order-table-btn completed-table-order-2">
                          <Link
                            to={`/supplier/proforma-invoice/${order.purchaseOrder_id}`}
                          >
                            <div className="ongoing-section-button-section-cont">
                              <span className="ongoing-section-orders-button">
                                Make Order
                              </span>
                            </div>
                          </Link>
                          <Link
                            to={`/supplier/purchased-order-details/${order.purchaseOrder_id}`}
                          >
