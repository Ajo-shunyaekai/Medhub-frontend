...
import ProductList from "../../Inquiry/Inquiry/ProductList";
  ...
  return (
    <div className="buyer-order-details-container">
      ...
      <div className="pending-order-button-section">
        ...
        <a
          href="mailto:supplier@example.com?subject=Inquiry%20about%20Order%20987456321"
          className="pending-order-contact-order"
        >
          Contact Supplier
        </a>
      </div>
