...
function PayModal({
  ...
  const handleImageUploadStatus = (status, image) => {
    ...
    setErrors((prevErrors) => ({
      ...prevErrors,
      image: status ? "" : "Image is required",
    }));
  };
  ...
  const validateForm = () => {
    ...
    errors.modeOfPayment =
      modeOfPayment === "" ? "Mode of Payment is required" : "";
    errors.amount = !validateAmount(amount) ? "Amount Paid is Required" : "";
    errors.transactionId = !validateTransactionId(transactionId)
