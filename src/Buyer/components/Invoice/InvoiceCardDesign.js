    ...
    <>
        ...
        <div className={styles["invoice-card-design-inner"]}>
          <div className={styles["invoice-card-section"]}>
            <div className={styles["invoice-card-conts"]}>
              <div className={styles["invoice-card-conts-head"]}>
                Mode of Payment :
              </div>
              <div className={styles["invoice-card-conts-text"]}>
            ...
            <div className={styles["invoice-card-conts"]}>
              ...
              <div className={styles["invoice-card-conts-text"]}>
                {invoiceDetails?.amount_paid} USD
              </div>
            </div>
          </div>
          <div className={styles["invoice-card-section"]}>
      ...
      <div className={styles["invoice-card-img-container"]}>
        <div className={styles["invoice-card-img"]}>
          <img
            src={
              invoiceDetails?.transaction_image?.[0]?.startsWith("http")
                ? invoiceDetails?.transaction_image?.[0]
                : `${process.env.REACT_APP_SERVER_URL}uploads/buyer/order/invoice_images/${invoiceDetails?.transaction_image?.[0]}`
            }
            alt="Cheque"
            onClick={openModal}
      ...
      {isModalOpen && (
        <div className={styles["modal-overlay"]}>
          <div className={styles["modal-content"]}>
            <span onClick={closeModal} className={styles["close-button"]}>
              &times;
            </span>
            <img
              src={
