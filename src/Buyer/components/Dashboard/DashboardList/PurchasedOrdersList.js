              ...
              <tbody className="bordered">
                {poList && poList.length > 0 ? (
                  poList.map((order, index) => {
                    ...
                    return (
                      <div
                        key={order.purchaseOrder_id}
                        className="completed-table-row-container"
                      >
                        <div className="completed-table-row-item completed-table-order-1">
                        ...
                        <div className="completed-table-row-item completed-table-order-1">
                          ...
                          <div className="completed-table-text-color">
                            {order.total_amount || totalAmount} USD
                          </div>
                        </div>
                        <div className="completed-table-row-item completed-order-table-btn completed-table-order-1">
                          <Link
                            to={`/buyer/purchased-order-details/${order.purchaseOrder_id}`}
                          >
                            <div
